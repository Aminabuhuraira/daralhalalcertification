...
export default function PaymentCTA({ payments, locale }: Props) {
  const invoice = payments[0];

  return (
    <div style={{ padding: "18px 20px", borderRadius: 12, background: "rgba(14,165,233,0.06)", border: "1px solid rgba(14,165,233,0.25)", marginBottom: 14 }}>
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
        <div>
          <p style={{ fontFamily: "var(--font-body)", fontSize: 13, fontWeight: 700, color: "#0369A1", marginBottom: 4 }}>
          ...
          {invoice ? (
            <p style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "rgba(10,21,53,0.65)", lineHeight: 1.5 }}>
              ...
              <span style={{
                ...
                borderRadius: 4, background: invoice.status === "COMPLETED" ? "rgba(34,197,94,0.1)" : "rgba(245,158,11,0.1)",
                color: invoice.status === "COMPLETED" ? "#16A34A" : "#D97706",
                border: `1px solid ${invoice.status === "COMPLETED" ? "rgba(34,197,94,0.3)" : "rgba(245,158,11,0.3)"}`,
              }}>
                {invoice.status}
              </span>
            </p>
          ...
          <p style={{ fontFamily: "var(--font-body)", fontSize: 12, color: "rgba(10,21,53,0.45)", marginTop: 6 }}>
            To complete payment, please contact our Finance team or use the bank transfer details in your invoice email.
          </p>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <a
            ...
            style={{
              ...
              color: "rgba(10,21,53,0.55)", transition: "all 0.15s",
            }}
          >
