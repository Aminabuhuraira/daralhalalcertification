      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "72px 24px 40px", position: "relative", zIndex: 1 }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr 1fr", gap: 48, marginBottom: 56 }} className="footer-grid">
          ...
          <div>
            ...
            <p style={{ fontFamily: "var(--font-body)", fontSize: 14.5, color: "rgba(10,21,53,0.5)", lineHeight: 1.75, marginBottom: 24, maxWidth: 270 }}>
              ...
              <ul style={{ listStyle: "none" }}>
                {col.links.map(([label, href]) => (
                  <li key={href} style={{ marginBottom: 10 }}>
                    <Link
                      href={lh(href)}
                      style={{ fontFamily: "var(--font-body)", fontSize: 14.5, color: "rgba(10,21,53,0.5)", textDecoration: "none", transition: "color 0.2s" }}
                  ...
                  {[
                    ...
                    return (
                      <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 8 }}>
                        ...
                        <span style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "rgba(10,21,53,0.5)", lineHeight: 1.5 }}>{text as string}</span>
                      </div>
                    );
                  })}
                </div>
          ...
          <div>
            ...
            <h4 style={{ fontFamily: "var(--font-accent)", fontSize: 10, fontWeight: 700, color: "rgba(10,21,53,0.35)", letterSpacing: "0.2em", marginBottom: 12 }}>GET THE APP</h4>
            <div style={{ display: "flex", flexDirection: "column", gap: 9 }}>
              ...
              >
                ...
                <div style={{ lineHeight: 1.2 }}>
                  <div style={{ fontFamily: "system-ui,-apple-system,sans-serif", fontSize: 9, color: "rgba(10,21,53,0.45)", letterSpacing: "0.01em" }}>Download on the</div>
              ...
              >
                ...
                <div style={{ lineHeight: 1.2 }}>
                  <div style={{ fontFamily: "system-ui,-apple-system,sans-serif", fontSize: 9, color: "rgba(10,21,53,0.45)", textTransform: "uppercase", letterSpacing: "0.06em" }}>Get it on</div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 24, flexWrap: "wrap" }}>
            <p style={{ fontFamily: "var(--font-body)", fontSize: 13.5, color: "rgba(10,21,53,0.35)" }}>© 2026 Dar Al Halal Certification. All rights reserved.</p>
            <Link href={lh("/terms")} style={{ fontFamily: "var(--font-body)", fontSize: 12.5, color: "rgba(10,21,53,0.35)", textDecoration: "none" }}>Terms</Link>
            <Link href={lh("/privacy")} style={{ fontFamily: "var(--font-body)", fontSize: 12.5, color: "rgba(10,21,53,0.35)", textDecoration: "none" }}>Privacy</Link>
          </div>
