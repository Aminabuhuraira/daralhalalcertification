    ...
    <>
      ...
      <main style={{ paddingTop: 72, minHeight: "100vh", background: "var(--bg-surface)" }}>
        <section style={{ padding: "80px 0 100px", position: "relative", overflow: "hidden" }}>
          <div className="glow-orb glow-orb-purple" style={{ width: 420, height: 420, top: -100, right: -100, opacity: 0.14 }} />
          <div className="glow-orb glow-orb-purple" style={{ width: 300, height: 300, bottom: -80, left: -80, opacity: 0.1 }} />
